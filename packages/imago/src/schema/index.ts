...
export const schema = {
  ...
  MusicPlaylist: defineType<MusicPlaylistComponent>('schema:MusicPlaylist', 'section', MusicPlaylist),
  MusicRecording: defineType<MusicRecordingComponent>('schema:MusicRecording', 'li', MusicRecording),
